...
namespace fenm {
	...
	public:
		...
		template <typename _T2> friend std::ostream& operator << (std::ostream& os, const type_vec4<_T2> v);
	...
	template <typename _T> double dot(const type_vec4<_T>& v1, const type_vec4<_T>& v2);
